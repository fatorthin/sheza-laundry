<div>
    ...
    @if ($result)
        ...
        {{ match ($result->status) {
            ...
            <!-- Progress steps -->
            @php
                $steps = ['baru', 'dikerjakan', 'siap_diambil', 'selesai'];
                $labels = ['Baru', 'Dikerjakan', 'Siap Diambil', 'Selesai'];
            ...
            <div class="text-xs text-[#534434] space-y-1">
                ...
                <div class="flex justify-between">
                    ...
                    <span
                        class="{{ $result->payment_status === 'lunas' ? 'text-green-600' : 'text-red-500' }} font-medium">
